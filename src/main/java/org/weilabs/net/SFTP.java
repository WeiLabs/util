...
public class SFTP {
    ...
    public static void main(String[] args) throws Exception {
    	SFTP sftp = new SFTP("192.168.126.128", 22, "tiger", "111");
        sftp.upload("D:/opt/lkl-statement-2016-10.xlsx", "/opt", 1);
        sftp.download("/opt/lkl-statement-2016-10.xlsx", "D:/tmp");
